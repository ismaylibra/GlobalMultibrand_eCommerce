...
namespace GMB.DAL.Migrations
{
    ...
    [Migration("20230821150604_AddedNewColumnToProductAndSizeTables")]
    partial class AddedNewColumnToProductAndSizeTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GMB.Core.Entities.Product", b =>
                {
                    b.HasOne("GMB.Core.Entities.Brand", "Brand")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("GMB.Core.Entities.ProductColor", b =>
                {
                    b.HasOne("GMB.Core.Entities.Color", "Color")
            ...
            modelBuilder.Entity("GMB.Core.Entities.ProductSize", b =>
                {
                    ...
                    b.HasOne("GMB.Core.Entities.Size", "Size")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GMB.Core.IdentityModels.User", null)
                        .WithMany()
